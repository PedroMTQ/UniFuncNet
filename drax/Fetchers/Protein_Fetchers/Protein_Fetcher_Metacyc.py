from drax.Fetchers.Protein_Fetchers.Protein_Fetcher import *

class Protein_Fetcher_Metacyc(Protein_Fetcher):
    ...
    def converge_protein_to_protein(self):
        ...
        for entry_type in convergence_dict:
            for protein_id in self.convergence_args[entry_type]:
                ...
                if entry_type in ['complex','subunits']: convergence_search=True
                else: convergence_search=False
...
if __name__ == '__main__':
    ...
    protein=Protein_Fetcher_Metacyc('CYT-D-UBIOX-CPLX')
    #protein=Protein_Fetcher_Metacyc('CPLX-2401')
    #protein=Protein_Fetcher_Metacyc('MONOMER-2782')
    #protein=Protein_Fetcher_Metacyc('5.3.1.26')
