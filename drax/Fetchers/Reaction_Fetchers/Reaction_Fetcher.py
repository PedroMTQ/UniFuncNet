#DRAX modules
from drax.Fetchers.Global_Fetcher import *
from drax.Utils.util import get_stoichiometry,sub_prod_to_reaction
...
class Reaction_Fetcher(Global_Fetcher):
    ...
    def find_gene(self,query_id=None,extra_args={}):
        ...
        if memory_type=='Gene_Searcher':
            ...
            return self.memory_storage.gene_searcher.run_searcher(bio_db=self.db,bio_query=query_id,extra_args=extra_args)
