...
from unifuncnet.biological_components.utils.unique_details import (generate_details_dict,
                                                                   get_details_list,
                                                                   get_unique_details)
...
class GlobalFetcher():
    ...
    def get_with_fetcher(self, url,
                         ...
                         type_search='find',
                         kegg_option=None):
        return self.memory_storage.get_with_fetcher(url=url,
                                                    api_kegg=api_kegg,
                                                    data=data,
