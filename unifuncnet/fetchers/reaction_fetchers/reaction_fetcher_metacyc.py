...
class ReactionFetcherMetacyc(ReactionFetcher):
    ...
    def get_reaction_metacyc(self):
        ...
        if 'reaction_stoichiometry' in reaction_info:
            ...
            reaction_info['reaction_with_instances'] = self.reaction_met_instances_simple(reaction_stoichiometry,
                                                                                          'metacyc')
...
if __name__ == '__main__':
    ...
    rn_search = ReactionFetcherMetacyc('RXN-14064')
