...
class ReactionFetcherRhea(ReactionFetcher, RheaSqliteConnector):
    ...
    def get_reaction_rhea(
            self):  # this basically gets all the details from rhea, may be able to implement a more concise search, see later
        ...
        if reaction_info:
            ...
            if rn_with_instances:
                reaction_dict['reaction_with_instances'] = rn_with_instances
            else:
...
if __name__ == '__main__':
    rn_search = ReactionFetcherRhea('10000')
