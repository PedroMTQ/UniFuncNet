...
class GeneFetcherHmdb(GeneFetcher):
    ...
    def set_convergence_args(self, extra_args):
        ...
        if 'gene_soup' in extra_args:
            self.convergence_args['gene_soup'] = extra_args['gene_soup']
        else:
            self.convergence_args['gene_soup'] = None
...
if __name__ == '__main__':
    ...
    gene = GeneFetcherHmdb('HMDBP00087').get_gene()
