from unifuncnet.Utils.util import get_instance_type, check_if_any_none, number_of_nones_dict, unite_instance_list,number_of_nones_dict,find_path,SCRAPPABLE_DBS,download_file_ftp,UniFuncNet_FOLDER,RESOURCES_FOLDER,gunzip
...
from unifuncnet.Utils.CHEBI_SQLITE_Connector import CHEBI_SQLITE_Connector
