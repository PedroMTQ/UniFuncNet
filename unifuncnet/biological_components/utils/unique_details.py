from unifuncnet.utils.util import get_instance_type, SCRAPPABLE_DBS
...
def get_unique_details(bio_instance=None,
                       bio_instance_type=None,
                       remove_from_list=[],
                       append_to_list=[]):
    res = []
    if type(remove_from_list) == str:
        remove_from_list = [remove_from_list]
    if type(append_to_list) == str:
