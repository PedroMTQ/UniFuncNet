...
class UniFuncNet_Neo4j_Connector():
    ...
    def get_reaction_compounds_neo4j(self,unifuncnet_id,reaction_str,stoichiometry):
        ...
        for cpd_id in left_side:
            ...
            item={'start_unifuncnet_id':unifuncnet_id,'end_unifuncnet_id':cpd_id,'stoichiometry':current_stoichiometry}
                    ...
                    for connection_id in node_info[connection_type]:
                        ...
                        if connection_type =='reaction_compounds':
                            if 'stoichiometry' in node_info:
                                ...
                                reaction_compounds=self.get_reaction_compounds_neo4j(unifuncnet_id,connection_id,stoichiometry)
