...
class CompoundsToOrganismsMapping:
    def __init__(self,
                 input_samples,
                 metabolites,
                 output_folder,
    ...
    def run_unifuncnet(self):
        ...
        if not os.listdir(self.unifuncnet_output):
            if self.database:
                run_unifuncnet_command = f'unifuncnet -i {self.unifuncnet_input} -o {self.unifuncnet_output} -pt {self.politeness_timer} -db {self.database}'
            else:
    ...
    def get_organisms_to_metabolites(self, mapped_organisms, mapping, metabolites, linked_reactions, reactions_info):
        for organism in mapped_organisms:
            ...
            proteins_to_reactions = self.get_proteins_to_reactions(linked_reactions, organisms_protein_ids,
                                                                   reactions_info)
    ...
    def output_results(self):
        ...
        organisms_annotations = [f'{self.mantis_output}{org}{SPLITTER}consensus_annotation.tsv' for org in
                                 os.listdir(self.mantis_output)]
        ...
        organisms_to_metabolites = self.get_organisms_to_metabolites(mapped_organisms, mapping, metabolites,
                                                                     linked_reactions, reactions_info)
